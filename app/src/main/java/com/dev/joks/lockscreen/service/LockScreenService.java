...
import com.dev.joks.lockscreen.activity.LockActivity;
...
public class LockScreenService extends Service {
    ...
    public void onDestroy() {
        Log.d(TAG, "LockScreenService stopped");
        stateRecever(false);
        setStandardKeyguardState(true);
    }

    private void startLockscreenActivity() {
        Intent startLockscreenActIntent = new Intent(mContext, LockActivity.class);
